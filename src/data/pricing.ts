...
export const oneTimeServices = [
  ...
  { id: 'reg-ooo', name: 'Регистрация ООО', price: 'от 5 000 ₽', sub: 'устав, решение, подача документов', estimate: true },
  ...
  { id: 'address', name: 'Юридический адрес в Калмыкии для ООО', price: 'от 5 000 ₽/мес', sub: 'реальный офис, почта, гарантийное письмо', estimate: true },
  { id: 'account', name: 'Открытие расчётного счёта', price: 'Бесплатно', sub: 'подберём банк под ваши обороты', estimate: true },
  { id: 'ndfl', name: '3-НДФЛ для физических лиц', price: 'от 1 500 ₽', sub: 'вычеты за жильё, лечение, обучение; продажа имущества, ИИС, доходы из-за рубежа', estimate: true },
  { id: 'foreign', name: 'Уведомление о счёте за рубежом', price: 'от 1 500 ₽', sub: 'для физлиц: открытие, закрытие, отчёт о движении средств', estimate: true },
  { id: 'zero', name: 'Нулевая отчётность', price: 'от 2 500 ₽/кв', sub: 'ИП и ООО без движений', estimate: true },
  { id: 'hr', name: 'Кадровый учёт', price: 'от 1 000 ₽/сотр.', sub: 'приём, увольнение, отпуска, больничные, воинский учёт', estimate: true },
