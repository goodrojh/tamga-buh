...
const faqData: Record<string, FAQItem[]> = {
  ...
  kalmykia: [
    ...
    { question: 'Сколько занимает регистрация?', answer: 'ИП — 3 рабочих дня после подачи, ООО — 3–5. Готовим и подаём документы сами, расчётный счёт открываем параллельно.' },
  ],
  payments: [
