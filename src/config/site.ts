...
export const site = {
  brand: 'ТАМГАБУХ',
  /** Владелец / основатель. TODO: имя и отчество, должность уточнить у клиента */
  owner: {
    name: 'Надвидов', // TODO: полное имя (Имя Отчество Надвидов)
    role: 'Основатель и руководитель ТамгаБух',
  },
  /** Свидетельство на товарный знак (Роспатент) */
  trademark: {
    name: 'ТАМГАБУХ',
    number: '1226547',
    application: '2026709620',
